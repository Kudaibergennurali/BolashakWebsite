...
export const translations = {
  ...
  kk: {
    ...
    "about.innovation.desc": "Студенттерді ертеңгі күнге дайындау үшін заманауи мүмкіндіктер мен жаңа технологиялар.",
    ...
    "spec.engineering": "Есептік істер",
    "spec.engineering.desc": "Бастауыш білім беру, Банк және сақтандыру ісі, Есеп және аудит",
    "spec.business": "Технология бағыты",
    "spec.business.desc": "Бағдарламалық қамтамасыз ету, Дәнекерлеу ісі",
    "spec.science": "Техникалық жұмыстар",
    "spec.science.desc": "Автомашиналарға қызмет көрсету, Мектепке дейінгі тәрбие және оқыту, Дене тәрбиесі және спорт",
    "spec.arts": "Әлеуметтік қызмет",
    "spec.arts.desc": "Құқықтандыру, Тамақтандыруды ұйымдастыру",
    ...
    "event.openday": "Ашық күн 2026",
    "event.openday.desc": "15 наурыз, 2026 - Кампус турлары және бағдарлама ақпараты",
    "event.competition": "Колледжаралық жарыс",
    "event.competition.desc": "2-5 сәуір, 2026 - Академиялық және спорт жарыстары",
